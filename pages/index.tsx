  ...
  return (
    <footer ref={ref} className={styles.footer} data-animate={isInView}>
      <div className={styles.footerText}>
        Crafted by{' '}
        <a href="https://www.athromic.com" target="_blank" rel="noopener noreferrer">
          <img src="/vercel.svg" alt="Avatar of Paco" />
          Athromic
        </a>{' '}
        and directly inspired from{' '}
        <a href="https://github.com/pacocoursey/cmdk" target="_blank" rel="noopener noreferrer">
